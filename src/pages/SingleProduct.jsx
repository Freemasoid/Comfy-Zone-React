...
export const loader =
  (queryClient) =>
  async ({ params }) => {
    const response = await queryClient.ensureQueryData(singleProdQuery(params.id));
      ...
      <div className="mt-6 grid gap-y-8 lg:grid-cols-2 lg:gap-x-16">
        ...
        <div>
          ...
          <div className="form-control w-full max-w-xs">
            ...
            <select
              className="select select-secondary select-ordered select-md"
              value={amount}
